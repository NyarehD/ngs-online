...
function Header() {
    ...
    return (
        <>
            <div
                className={
                    `${fix ? `${Style.container} ${Style.stickyBar}` : `${Style.container}`} ${darkMode.mode !== "light"?Style.containerDark:""}`
                }
            >
                {/* <ul>
          <li
              ...
              <MenuItem onClick={handleClose}>
                ...
                <ul>
                    <li
                        onClick={() => setIndex(0)}
                    >
                        <Link className={`${index === 0 ? `${Style.navActive}` : ``}`} type="button"
                              to={"/"}>Home</Link>
                    </li>
                    <li
                        ...
                        onClick={() => setIndex(1)}
                    >
                        <Link className={`${index === 1 ? `${Style.navActive}` : ``}`} type="button"
                              to={"/team-list"}>Team</Link>
                    </li>
                    <li

                        onClick={() => setIndex(2)}
                    >
                        <Link className={`${index === 2 ? `${Style.navActive}` : ``}`} type="button"
                              to={"/event-list"}>Event</Link>
                    </li>
                    <li

                        onClick={() => setIndex(3)}
                    >
                        <Link className={`${index === 3 ? `${Style.navActive}` : ``}`} type="button"
                              to={"/about"}>About</Link>
                    </li>
                    <li
                        ...
                        onClick={() => setIndex(4)}
                    >
                        <Link className={`${index === 4 ? `${Style.navActive}` : ``}`} type="button"
                    ...
                    <li
                        ...
                        onClick={() => setIndex(5)}
                    >
                        <Link className={`${index === 5 ? `${Style.navActive}` : ``}`} type="button"
                              to={"/blog"}>Blog</Link>
                    </li>
                    <li
                        onClick={() => setIndex(6)}
                    >
                        <Link className={`${index === 6 ? `${Style.navActive}` : ``}`} type="button"
                              to={"/faq"}>Faq</Link>
                    </li>
                    <li>
                        <a

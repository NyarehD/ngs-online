...
import {faAngleRight, faComments, faHeart, faMagnifyingGlass, faTags} from "@fortawesome/free-solid-svg-icons";
...
const BlogContainer = ({togglePosts, currentPosts, pageNumber, paginate, currentPostsByFilter, currentPage}) => {
    return (<div className={BlogListStyle.blogList_left_container}>

        {/* start Blog Post */}
        {togglePosts ? currentPostsByFilter?.map((post, i) => <Blog key={i}
                                                                    post={post}/>) : currentPosts?.map((post, i) =>
...
const BlogHelperContainer = ({
    ...
    return (<div className={BlogListStyle.blogList_right_container}>
        ...
        <div className={`${BlogListStyle.recent_post_container} ${BlogListStyle.mb}`}>
            ...
            <ul className={BlogListStyle.recent_posts}>
                {posts
                    ?.map((post, i) => (<li key={i} className={BlogListStyle.recent_post}>

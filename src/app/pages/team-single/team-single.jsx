    ...
    <div className="">
        ...
        <div className={TeamSingleStyle.personalExperienceContainer}>
            ...
            <div className={TeamSingleStyle.content}>
                <h5 className={TeamSingleStyle.content_title}>Personal Experience</h5>
                <p className={TeamSingleStyle.content_text}>Doloremque quam. Exercitation totam or cupidatat culpa but autem. In labore so nostrud asper natur officia magna, so quasi. Sit nequeporro dolor Iure. Pellentesque lorem mauris, vehicula vel nulla nec.</p>
            </div>

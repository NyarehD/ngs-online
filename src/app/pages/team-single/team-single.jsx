    ...
    <div className="">
      ...
      <div className={TeamSingleStyle.container}>
        <div className={TeamSingleStyle.row}>
          <div
            className={`${TeamSingleStyle.col_xs_12} ${TeamSingleStyle.col_md_6} ${TeamSingleStyle.col_lg_6}`}
          >
            <img
              src={TeamSinglePhoto}
          ...
          >
            <div
              className={`${TeamSingleStyle.divider - 20} ${
                TeamSingleStyle.displaySmBlock
              } ${TeamSingleStyle.displayLgNone}`}
            ></div>
            ...
            <table className={TeamSingleStyle.table}>
              <tbody>
                <tr>
                ...
                <tr>
                  ...
                  <td className={TeamSingleStyle.link_a}>
                    deanwhales@MaxiCom.com
                  </td>
                </tr>
          ...
          <div className={TeamSingleStyle.personalExperienceContainer}>
            <div className={TeamSingleStyle.content}>
              ...
              <p className={TeamSingleStyle.content_text}>
                Doloremque quam. Exercitation totam or cupidatat culpa but
                autem. In labore so nostrud asper natur officia magna, so quasi.
                Sit nequeporro dolor Iure. Pellentesque lorem mauris, vehicula
                vel nulla nec.
              </p>
            </div>
        ...
        {/* <h5 className={TeamSingleStyle.contactTitle}>Contact Me</h5>
                <form  className={TeamSingleStyle.row}>
                    ...
                    <div className={`${TeamSingleStyle.col_xs_12} ${TeamSingleStyle.teamSingleBorderWrap}`}>
                            <button className={TeamSingleStyle.submitFormButton}>
                                <span className={TeamSingleStyle.form_submit_text}>Submit</span>
                            </button>
                    </div>

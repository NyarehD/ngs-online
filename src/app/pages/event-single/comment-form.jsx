...
const CommentForm = ({
    ...
    const darkMode = themeStyle === 'dark' ? {
        'background': CommentStyle.darkBackground,
        'color': CommentStyle.darkTextColor,
        'InputBox': CommentStyle.darkInputBox
    } : {}
    ...
    return (
        <form onSubmit={onSubmit} className={CommentStyle.sommentSubmitForm}>
            ...
            <div className={CommentStyle.submitBtnGroup}>
                <button className={CommentStyle.commentFormButton}
                        disabled={isEditing ? isEditInputDisable : isInputsDisable}>

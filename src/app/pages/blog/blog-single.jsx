...
import {faCalendarDays, faUserLarge, faEye, faComments, faHeart, faBasketball, faAngleRight, faCircle} from "@fortawesome/free-solid-svg-icons"
            ...
            <div>
                <section className={HeaderStyle.box}>
                    ...
                    <div className={HeaderStyle.breakCrumb}>
                        ...
                        <li className={HeaderStyle.breakCrumbList}>
                            <a href="/blog" className={HeaderStyle.link}>
                                    ...
                                    <ul className={BlogStyle.blog_list}>
                                        {
                                            blog.lists.map(list=>{
                                                return( 
                                                <li key={list.id} className={`${BlogStyle.blog_list_items} ${themeStyle?.color}`}>
                                                    <FontAwesomeIcon
                                                        icon={faCircle}
                                                        className={BlogStyle.blog_list_itemsCircle}
                                                    />
                                                    {list.content}
                                                </li>
                                                )
                                    ...
                                    <div className={BlogStyle.blog_reaction}>
                                        <div className={BlogStyle.blog_tags}>
                                            ...
                                            <div className={BlogStyle.tag_items}>
                                                {
                                                    blog.tag.map(tag=>{
                                                        return <a key={tag.id} className={ `${mode==='light'? BlogStyle.tags_item : BlogStyle.tagsDark_item} ${themeStyle?.color}`} href="#">{tag.tagIext}</a>

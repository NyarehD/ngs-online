...
const AddressList = () => {
  ...
  const darkTheme = mode.mode === 'dark'?ContactStyle.darkTheme:''
  return (
    <div className={ContactStyle.address_list_container}>
      ...
      <div className={ContactStyle.contact_info}>
        <h1
          className={
            mode.mode === "light"
              ? ContactStyle.contact_headLight
              : ContactStyle.contact_headDark
          }
        >
          Contact Info
        </h1>
        <div className={darkTheme}>
          <div className={ContactStyle.contact_location}>
            ...
            <span
              className={
                mode.mode === "light"
                  ? ContactStyle.addressLight
                  : ContactStyle.addressDark
              }
            >
              Yangon,Myanmar
            </span>
          ...
          <div className={ContactStyle.contact_location}>
            ...
            <span className={ContactStyle.address}>
              designteam.ngs@gmail.com
            </span>
          </div>
        </div>
      </div>
      ...
      {/* Opening-days start  */}
      <div className={`${ContactStyle.contact_days} ${darkTheme}`}>
        <h1
          className={
            mode.mode === "light"
              ? ContactStyle.contact_headLight
    ...
    <div className={ContactStyle.contact_form_container}>
      ...
      <form action="">
        <div className={ContactStyle.form_input_container}>
          <input
            className={`${ContactStyle.form_input} ${darkTheme}`}
            type="text"
            placeholder="NAME"
          />
          <input
        ...
        <div className={ContactStyle.form_input_container}>
          <textarea
            className={`${ContactStyle.form_textarea}  ${darkTheme}`}
            cols="30"
            rows="10"
            placeholder="MESSAGE"
          />
